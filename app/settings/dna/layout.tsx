...
import { User, HelpCircle, SlidersHorizontal, LayoutList, Tag, Globe, ListChecks, Download, ArrowLeft, Settings } from 'lucide-react'
...
export default function DNALayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors">
      {/* Header */}
      <div className="sticky top-0 z-50 bg-gradient-to-r from-indigo-600 to-indigo-800 text-white shadow-lg">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-xl font-bold">DNA Profile Settings</h1>
              </div>
            </div>
          </div>
        </div>
